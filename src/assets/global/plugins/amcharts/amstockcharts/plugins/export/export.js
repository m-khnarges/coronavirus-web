		...
		var _this = {
			...
			download: function( data, type, filename ) {
				...
				if ( window.saveAs && _this.setup.hasBlob ) {
					...
					// FALLBACK IMAGE
				} else if ( _this.config.fallback && type.split( "../../../../../../../../../../default.htm" )[ 0 ] == "image" ) {
					var div = document.createElement( "div" );
					var msg = document.createElement( "div" );
				...
				function buildList( list, container ) {
					...
					for ( i1 = 0; i1 < list.length; i1++ ) {
						...
						if ( [ "CSV", "JSON", "XLSX" ].indexOf( item.format ) != -1 && [ "map", "gauge" ].indexOf( _this.setup.chart.type ) != -1 ) {
							...
							if ( item.mimeType && item.mimeType.split( "../../../../../../../../../../default.htm" )[ 0 ] != "image" && item.mimeType != "text/plain" ) {
								continue;
							}
						}
